...
Waterbase.prototype.collection = function (collectionName, callback) {
  return new Collection(collectionName, this.connection, callback);
};
...
var Collection = function (name, connection, callback) {
  this.name = name;
  this.io = connection;
  ...
  this.io.emit(
    ...
    this.handleResponse(function (data) {
      ...
      data.forEach(function (props, index) {
        collection._storage.push(new Model(props, collection.name, collection.io));
      });
